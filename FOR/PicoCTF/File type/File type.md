...
- Follow the instruction —> use sh Flag.pdf to extract file flag
- Check file type —> change the extension of the file —> extract file
- Note: use file <File> command when you cann’t check the file type
- do until we got text file with undecode message:

7069636f4354467b66316c656e406d335f6d406e3170756c407431306e5f6630725f3062326375723137795f39353063346665657d0a—-hex decode—→picoCTF{f1len@m3_m@n1pul@t10n_f0r_0b2cur17y_950c4fee}
